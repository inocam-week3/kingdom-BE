...
public class QComment extends EntityPathBase<Comment> {
    ...
    private static final long serialVersionUID = 232540218L;
    ...
    public final sparta.kingdombe.domain.story.entity.QStory story;
    ...
    public QComment(Class<? extends Comment> type, PathMetadata metadata, PathInits inits) {
        ...
        this.story = inits.isInitialized("story") ? new sparta.kingdombe.domain.story.entity.QStory(forProperty("story"), inits.get("story")) : null;
